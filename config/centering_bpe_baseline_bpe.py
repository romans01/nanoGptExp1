# Эксперимент с центрированием: baseline_bpe
# Базовая BPE модель без центрирования (24 слоя)
# Базируется на train_shakespeare_bpe.py

# Базовые настройки
out_dir = 'out-centering-bpe-baseline_bpe'
