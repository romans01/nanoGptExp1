# Эксперимент с центрированием: block_centered_bpe
# BPE модель с центрированием выходов блоков
# Базируется на train_shakespeare_bpe.py

# Базовые настройки
out_dir = 'out-centering-bpe-block_centered_bpe'
...
wandb_run_name = 'block_centered_bpe'
