# Эксперимент с центрированием: full_centered_bpe
# BPE модель с полным центрированием (QK + финальные)
# Базируется на train_shakespeare_bpe.py

# Базовые настройки
out_dir = 'out-centering-bpe-full_centered_bpe'
...
wandb_run_name = 'full_centered_bpe'
