# Эксперимент с центрированием: momentum_centered_bpe
# BPE модель с центрированием momentum (лучший из предыдущих)
# Базируется на train_shakespeare_bpe.py

# Базовые настройки
out_dir = 'out-centering-bpe-momentum_centered_bpe'
...
wandb_run_name = 'momentum_centered_bpe'
