# Эксперимент с центрированием: qk_centered_bpe
# BPE модель с центрированием query/key в attention
# Базируется на train_shakespeare_bpe.py

# Базовые настройки
out_dir = 'out-centering-bpe-qk_centered_bpe'
...
wandb_run_name = 'qk_centered_bpe'
