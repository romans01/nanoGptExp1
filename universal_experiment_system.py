...
def main():
    ...
    print("1. Комплексные эксперименты (16 экспериментов, ~20 мин)")
    print("2. Эксперименты с режимами (8 экспериментов, ~7 мин)")
    print("3. Быстрые тесты (4 эксперимента, ~5 мин)")
